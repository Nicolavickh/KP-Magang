<legend align="center"><h1>Update Topics</h1></legend>
<div align="center">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form method="post">
                    ...
                    <div class="card-body">
                        <input style="width: 100%" name="txtStartDate" value="<?php echo  $topic->status->start_date ?>" type="date" required>
                    </div>
                    ...
                    <div class="card-body">
                        <input style="width: 100%" name="txtFinishDate" value="<?php echo $topic->status->finish_date ?>" type="date" required>
                    </div>
                    ...
                    <input type="submit" value="Update Topic" name="btnUpdate">
                    <input type="reset">
                </form>
            </div>
        </div>
